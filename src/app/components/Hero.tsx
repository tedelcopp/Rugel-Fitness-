...
/>
  ...
  <div className="mt-6 flow-root">
    <div className="-my-6 divide-y divide-gray-500/10">
      ...
      <div className="relative isolate min-h-screen flex items-center justify-center px-6 pt-20 lg:px-8">
        <div
          aria-hidden="true"
  ...
  <h1 className="text-6xl font-semibold tracking-tight text-gray-900 dark:text-gray-100 sm:text-8xl">
    Rugel Fitness
  </h1>
