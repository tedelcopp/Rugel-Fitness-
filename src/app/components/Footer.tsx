      ...
      <footer className="bg-gray-900 text-gray-400 py-10 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <nav className="flex justify-center space-x-10">
            ...
            <a href="#plans" className="hover:text-white">Planes de Entrenamiento</a>
            <a href="#header" className="hover:text-white">Entrenemos</a>
        ...
        <p className="text-center text-sm text-gray-500 mt-10">
          &copy; {new Date().getFullYear()} Rugel Fitness. Todos los derechos se encuentran reservados.
        </p>
      </footer>
    );
  };
