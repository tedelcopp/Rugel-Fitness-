const Footer = () => {
  ...
  Planes de Entrenamiento
          ...
          <a href="#contact" className="hover:text-[#FFFFFF] hover:btext-sm sm:text-xl px-2 py-1 rounded">
            Contacto
          </a>
        </nav>
